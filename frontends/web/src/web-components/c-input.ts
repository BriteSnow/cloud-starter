// <origin src="https://raw.githubusercontent.com/BriteSnow/cloud-bigapp/master/frontends/web/src/web-components/c-input.ts" />
// (c) 2019 BriteSnow, inc - This code is licensed under MIT license (see LICENSE for details)

import { BaseFieldElement } from '@dom-native/ui';
import { attr, className, frag, on } from 'dom-native';
...
export class InputElement extends BaseFieldElement {
	...
	set focused(b: boolean) { className(this, { focused: b }) };
